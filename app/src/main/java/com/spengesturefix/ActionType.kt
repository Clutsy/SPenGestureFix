...
enum class ActionType(
    ...
    OPEN_WHEEL(R.string.action_open_wheel),
    SCREENSHOT(R.string.action_screenshot),
    SCREEN_WRITE(R.string.action_screen_write),
    SMART_SELECT(R.string.action_smart_select),
    ...
    CUSTOM_SHELL(R.string.action_custom_shell, needsTextTarget = true);
